...
const Hero = () => {
    return (
        <section class="bg-gray-100 dark:bg-gray-700">
            <div class="container mx-auto py-16 px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 md:grid-cols-2 items-center gap-8">
                    <div class="max-w-lg">
                        <h2 class="text-3xl font-extrabold text-gray-900 sm:text-4xl dark:text-white mb-4">denis juma</h2>
                        <p class="mt-4 text-gray-600 text-lg dark:text-gray-300"><span className='text-teal-900 font-extrabold'>JumaGPT</span>: Hello! I'm Denis Juma, a data scientist with a background in procurement and supply chain management. I'm passionate about integrating AI with supply chain processes to drive innovation and efficiency. Welcome to my portfolio!</p>
                    </div>
